		  ...
		  xhr.open(
			...
			<?php
				...
				try
				{
					...
					$stmt = $conn->prepare('select * result order by price,logDate desc');
					$stmt->execute();
					...
					foreach ($result as $value)
					{
						if($value->imgUrl!='None')
							echo "<div class='col-lg-4 col-md-4 col-sm-4 col-xs-6' style='text-align:center;margin-top:100px;'><img src='".$value->imgUrl."' style='width:80%;' alt=''/></div>";
						else
							echo "<div class='col-lg-4 col-md-4 col-sm-4 col-xs-6' style='text-align:center;margin-top:100px;'><img src='img/item1.png' style='width:80%;' alt=''/></div>";
